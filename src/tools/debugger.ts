				...
				if (!chrome.cookies) {
					throw new Error(
						`TELL THE USER: Cookie access is not available. The "cookies" permission needs to be added to the extension manifest.\n\n` +
							...
							`1. Find where you unpacked the localgeist extension files on your computer\n` +
							...
							`7. Click the reload/refresh button (circular arrow icon) on the localgeist extension card\n` +
