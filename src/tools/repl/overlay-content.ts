...
(function() {
	...
	if (document.getElementById('localgeist-repl-overlay')) {
		return;
	}

	// Create overlay container
	const overlay = document.createElement('div');
	overlay.id = 'localgeist-repl-overlay';
	...
	layer1.style.cssText = \`
		...
		animation: localgeist-shimmer-radial-1 3s ease-in-out infinite;
	\`;
	...
	layer2.style.cssText = \`
		...
		animation: localgeist-shimmer-radial-2 4s ease-in-out infinite;
	\`;
	...
	layer3.style.cssText = \`
		...
		animation: localgeist-shimmer-radial-3 5s ease-in-out infinite;
	\`;
	...
	borderGlow.style.cssText = \`
		...
		animation: localgeist-pulse 2s ease-in-out infinite;
	\`;
	...
	for (let i = 0; i < 20; i++) {
		...
		particle.style.cssText = \`
			...
			animation: localgeist-particle-float \${duration}s ease-in-out \${delay}s infinite;
		\`;
	...
	style.textContent = \`
		@keyframes localgeist-shimmer-radial-1 {
			0%, 100% {
				opacity: 0.8;
				transform: scale(1);
			}
		...
		@keyframes localgeist-shimmer-radial-2 {
			0%, 100% {
				opacity: 0.7;
		...
		@keyframes localgeist-shimmer-radial-3 {
			0%, 100% {
				opacity: 0.75;
		...
		@keyframes localgeist-particle-float {
			0%, 100% {
...
export function removeOverlayScript(): string {
	return `
(function() {
	const overlay = document.getElementById('localgeist-repl-overlay');
	if (overlay) {
		overlay.remove();
	}
})();
