import type { Attachment, MessageRenderer } from "@earendil-works/pi-web-ui";
import { registerMessageRenderer, type UserMessageWithAttachments } from "@earendil-works/pi-web-ui";
