...
### Web-UI Prompts
**File**: `../../pi/packages/web-ui/src/prompts/prompts.ts`
...
1. **Choose the right location**:
   - Shared/reusable tools → `../../pi/packages/web-ui/src/prompts/prompts.ts`
   - localgeist-specific tools → `../src/prompts/prompts.ts`
...
**Interfaces**:
- `../../pi/packages/web-ui/src/components/sandbox/SandboxRuntimeProvider.ts` - Provider interface

**Prompt Definitions**:
- `../../pi/packages/web-ui/src/prompts/prompts.ts` - Shared prompts and providers
- `../src/prompts/prompts.ts` - localgeist-specific prompts

**Provider Implementations**:
- `../../pi/packages/web-ui/src/components/sandbox/ArtifactsRuntimeProvider.ts` - Artifacts provider
...
- `../../pi/packages/web-ui/src/tools/artifacts/artifacts.ts` - Artifacts tool
